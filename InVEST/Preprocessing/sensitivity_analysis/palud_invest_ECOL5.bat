...
set folder=sensitivity_analysis/ECOL3/10plus
...
set folder=sensitivity_analysis/ECOL3/10minus
set folder_PALUD=sensitivity_analysis/null
...
REM #'   \item create_json: Logical, whether to create JSON config files
REM #'   \item SNH_id: Semi-natural habitat identifier
REM #'   \item sens_id: ID for sensitivity analysis (e.g., "ECOL3")
REM #' }
...
set folder=sensitivity_analysis/ECOL3/50plus
set folder_PALUD=sensitivity_analysis/null
...
set folder=sensitivity_analysis/ECOL3/50minus
set folder_PALUD=sensitivity_analysis/null

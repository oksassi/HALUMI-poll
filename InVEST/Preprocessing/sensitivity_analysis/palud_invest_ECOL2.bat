...
set folder=sensitivity_analysis/ECOL2/10plus
...
REM #'   \item sens_id: ID for sensitivity analysis (e.g., "ECOL2")
REM #' }
...
set folder=sensitivity_analysis/ECOL2/10minus
set folder_PALUD=sensitivity_analysis/null
...
set folder=sensitivity_analysis/ECOL2/50plus
set folder_PALUD=sensitivity_analysis/null
...
set folder=sensitivity_analysis/ECOL2/50minus
set folder_PALUD=sensitivity_analysis/null

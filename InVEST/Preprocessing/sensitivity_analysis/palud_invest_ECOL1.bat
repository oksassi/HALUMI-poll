...
set folder=sensitivity_analysis/ECOL1/10plus
...
REM #'   \item sens_id: ID for sensitivity analysis (e.g., "ECOL1")
REM #' }
...
set folder=sensitivity_analysis/ECOL1/10minus
set folder_PALUD=sensitivity_analysis/null
...
set folder=sensitivity_analysis/ECOL1/50plus
set folder_PALUD=sensitivity_analysis/null
...
set folder=sensitivity_analysis/ECOL1/50minus
set folder_PALUD=sensitivity_analysis/null
